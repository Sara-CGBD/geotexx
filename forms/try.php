...
<body>
<div class="container">
    <h1>ðŸ“ Thickness Test Report (Under 2kPa Pressure)</h1>
    ...
    <?php if ($error): ?>
        <div class="alert alert-error">âŒ <?php echo htmlspecialchars($error); ?></div>
    <?php endif; ?>
    ...
    <?php if ($canApprove && count($pendingReports) > 0): ?>
        <div class="pending-reports">
            <h2>ðŸ“‹ Pending Thickness Test Reports for Approval</h2>
            <table>
                <thead>
                    <tr>
                        <th>Report No</th>
