    ...
    <table class="test-table">
      ...
      <tbody id="wx_tbody">
        ...
        <tr data-row="<?php echo $row_num; ?>">
          ...
          <td>
            <div class="dir-btn-container" style="display:inline-flex; gap:6px;">
          ...
          <td><input type="number" step="0.01" min="0" name="breaking_force_after_<?php echo $row_num; ?>" data-row="<?php echo $row_num; ?>" class="bf-after" value="<?php echo htmlspecialchars($sd['breaking_force_after'] ?? ''); ?>" oninput="if(this.value < 0) this.value = 0; calculateForceRetain(this)"></td>
          <td><input type="number" step="0.01" min="0" name="breaking_force_before_<?php echo $row_num; ?>" data-row="<?php echo $row_num; ?>" class="bf-before" value="<?php echo htmlspecialchars($sd['breaking_force_before'] ?? ''); ?>" oninput="if(this.value < 0) this.value = 0; calculateForceRetain(this)"></td>
          <td><input type="text" name="force_retain_<?php echo $row_num; ?>" class="fr" value="<?php echo htmlspecialchars($sd['force_retain'] ?? ''); ?>" readonly class="readonly"></td>
          <td><input type="number" step="0.01" min="0" name="elongation_after_<?php echo $row_num; ?>" data-row="<?php echo $row_num; ?>" class="el-after" value="<?php echo htmlspecialchars($sd['elongation_after'] ?? ''); ?>" oninput="if(this.value < 0) this.value = 0; calculateStatistics()"></td>
          <td><input type="number" step="0.01" min="0" name="elongation_before_<?php echo $row_num; ?>" data-row="<?php echo $row_num; ?>" class="el-before" value="<?php echo htmlspecialchars($sd['elongation_before'] ?? ''); ?>" oninput="if(this.value < 0) this.value = 0; calculateStatistics()"></td>
          <td>
            <?php if ($initial_row_count > 1 || $row_num > 1): ?>
            <button type="button" onclick="removeWxRow(this)" style="padding:4px 8px; background:#dc3545; color:#fff; border:none; border-radius:4px; cursor:pointer; font-size:12px;">Delete</button>
            <?php endif; ?>
          </td>
        </tr>
        <?php endfor; ?>
...
function addWxRow() {
    ...
    row.innerHTML = `
        ...
        <td><button type="button" onclick="removeWxRow(this)" style="padding:4px 8px; background:#dc3545; color:#fff; border:none; border-radius:4px; cursor:pointer; font-size:12px;">Delete</button></td>
    `;
