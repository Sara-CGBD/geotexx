<?php
/**
 * API to fetch list of reference numbers from roll_entry for UV Test (Weathering Exposure Test)
 * Excludes references that have already been routed by AGM (same logic as QC Test Order)
 * Also excludes references that already have UV test reports
...
try {
    ...
    // Exclude references that already have UV test reports
    $references = [];
    $bundleReferences = [];
