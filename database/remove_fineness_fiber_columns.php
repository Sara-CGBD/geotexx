<?php
/**
 * Remove columns from fineness_fiber_reports table:
 ...
 * - test_temperature
 * 
 * Access via: http://localhost/geotex/database/remove_fineness_fiber_columns.php
 */
...
try {
    ...
    echo "<!DOCTYPE html><html><head><title>Remove Fineness Fiber Columns</title>";
    ...
    echo "<div class='container'><h1>Remove Columns from Fineness Fiber Reports</h1>";
